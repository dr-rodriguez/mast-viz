...
from mast_plot import make_map, output_map, make_plot, read_map, read_file_data
...
# Get from DB
df = get_db_data(mission="HST", limit=None, constraints="AND dataproduct_type='image' AND provenance_name!='HAP' ")
...
# region TESS
df = get_db_data(mission="TESS", limit=None, constraints="AND dataproduct_type='image' ")
...
# region GALEX
df = get_db_data(mission="GALEX", limit=None, constraints="AND dataproduct_type='image' ")
...
# region PS1
df = get_db_data(mission="PS1", limit=None, constraints="AND dataproduct_type='image' AND calib_level=3 ")
...
df = get_db_data(mission="K2", limit=None, constraints="AND dataproduct_type='image' AND calib_level=3 ")
